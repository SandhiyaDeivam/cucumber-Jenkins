$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/test/resources/featurefolder/scenario3.feature");
formatter.feature({
...
formatter.match({
  "location": "sample.user_opens_chrome_browser_and_opens_application()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "sample.user_entering_username_as_And_password_as(String,String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "sample.user_clicks_on_signin_button()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "sample.verify_login_result()"
});
formatter.result({
  "status": "passed"
});
